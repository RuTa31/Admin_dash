    ...
    <Box sx={{ maxWidth: 200, position: 'relative' }}>
        <Box sx={{ maxWidth: 150, height: 60 }}>
            ...
            <Card>
                <CardActionArea>
                    <CardContent>
                        <Box sx={{marginTop: 10, height: 100,display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                            <Box sx={{ '& > :not(style)': { m: 1 }, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                <Fab size="small" color="secondary" aria-label="add" sx={{display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgb(255,0,0,0.2)'}}>
